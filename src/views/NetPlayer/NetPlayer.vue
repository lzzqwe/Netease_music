        ...
        <div class="middle">
          ...
          <transition name="van-fade">
            <base-scroll
              ...
              class="lyric"
            >
              <div v-if="lines.length>0"  @click="showLyric">
                <p
              ...
              <div v-else @click="showLyric" style="width: 100%; height: 100%">
                暂无歌词
              </div>
            </base-scroll>
          </transition>
        ...
        <div class="bottom">
          <transition name="van-fade">
            <div v-show="!isFlag" class="operator_1">
              <span
                ...
                @click="_hanFavorite(currentSong)"
                class="iconfont"
              ></span>
          ...
          <div class="operator_2">
            ...
            <span
              ...
              class="iconfont iconbofangliebiao"
            ></span>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    playIcon() {
      return this.playing
        ? "iconfont iconbofang3 "
        : "iconfont iconbofang9 rotate_pause";
    },
    albumIcon() {
